...
def _get_or_create_center(db: Session, *, name: str, city: str, description: str,
    ...
    center = Center(
        ...
        phone="0500000000",
        email=None,
        working_hours="الأحد – الخميس، 9ص – 5م",
        is_active=True,
...
def build_pool(db: Session, *, now: datetime) -> SeedContext:
    ...
    centers = {
        ...
        "mobility": _get_or_create_center(
            db,
            name="مركز مسار للتأهيل الحركي",
            city="الرياض",
            description="مركز متخصص في العلاج الطبيعي والدعم الحركي.",
        ...
        "education": _get_or_create_center(
            db,
            name="مركز رواق للدعم التعليمي",
            city="جدة",
            description="مركز متخصص في خدمات الدعم التعليمي والتربية الخاصة.",
        ...
        "early_intervention": _get_or_create_center(
            db,
            name="مركز براعم للتدخل المبكر",
            city="جدة",
            description="مركز متخصص في خدمات التدخل المبكر والعلاج الوظيفي.",

  ...
  return (
    <section className="prototype-detail-page">
      ...
      <div className="profile-shortcuts">
        ...
        <Link to={`/children/${child.id}/center-matches`} className="profile-shortcut-link"><span>⌖</span><strong>مراكز مناسبة</strong><small>مطابقة مع احتياجات الملف</small></Link>
      </div>
